...
app.config["UPLOAD_DIR_BASE"] = 'flaskr/images/baseimg/'
app.config["UPLOAD_DIR_RASTER"] = 'flaskr/images/rastered/'
app.config["UPLOAD_DIR_LEVEL"] = ['flaskr/images/levelone/', 'flaskr/images/leveltwo/', 'flaskr/images/levelthree/']
